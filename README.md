...
Seja bem-vindo(a) ao meu perfil do GitHub. Sou desenvolvedor e estudante de Análise e Desenvolvimento de Sistemas, focado em criar aplicações e resolver problemas através do código.
...
- 💻 Atualmente estou focado em projetos **Fullstack** (Front-end e Back-end).
- 🌱 Estou sempre estudando novas tecnologias e evoluindo minhas habilidades.
- 🧠 Estudando para resolver problemas de rotas, configuração de APIs e conexões
- 🚀 Meu objetivo atual é dominar os fundamentos do desenvolvimento Fullstack através da prática diária.
